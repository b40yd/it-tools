...
import { Heart, Home2, Menu2, Database } from '@vicons/tabler';
      ...
      <div class="sider-content">
        ...
        <div class="footer">
          <div>
            ...
            <c-link target="_blank" rel="noopener" :href="`https://github.com/b40yd/it-tools/tree/v${version}`">
              v{{ version }}
            </c-link>
            ...
            <template v-if="commitSha && commitSha.length > 0">
              ...
              <c-link
                ...
                rel="noopener"
                type="primary"
                :href="`https://github.com/b40yd/it-tools/tree/${commitSha}`"
              >
                {{ commitSha }}
              </c-link>
            </template>
